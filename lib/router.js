...
export default (app, { router, store, domainConfig }) => {
    router.beforeEach((to, from, next) => {
        ...
        for(const matched of to.matched) {
            ...
            const documentRoute = domainConfig.documentRoutes[matched.meta.refId]
            if (documentRoute) {
                ...
                if (typeof documentRoute.document.meta.woo == 'string') {
                    ...
                    action = { 
                        endpoint: documentRoute.document.meta.woo.endpoint + '/', 
                        data: {...documentRoute.document.meta.woo}
                    }
